...
public class ChargeableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chargeable);
...
//                                    mrefreshcoba.setVisibility(View.VISIBLE);
        ...
        maddFoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotoaddfoc = new Intent(ChargeableActivity.this, AddDetailsPo.class);
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (statusnya.equals("OK")){
                    ...
                    for (int i = 0; i < liststatus.size(); ++i) {
                        ...
                        final ArrayAdapter<String> kategori = new ArrayAdapter<String>(ChargeableActivity.this, R.layout.spinstatus_layout,
                                listnamestatus);
...
//                    page++;
    ...
    public void cekInternet(){
                ...
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED)
        {
            ...
            internet=false;
            Intent noconnection = new Intent(ChargeableActivity.this, NoInternet.class);
    ...
    public void sesionid() {
        if (MsessionExpired.equals("false")) {
            if (MhaveToUpdate.equals("false")) {
                ...
                Intent gotoupdate = new Intent(ChargeableActivity.this, UpdateActivity.class);
                startActivity(gotoupdate);
                finish();
            }

        }else {
            startActivity(new Intent(ChargeableActivity.this, LoginActivity.class));
            finish();
            Toast.makeText(ChargeableActivity.this, getString(R.string.title_session_Expired),Toast.LENGTH_LONG).show();
        }

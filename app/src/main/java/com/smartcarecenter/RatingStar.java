...
public class RatingStar extends AppCompatActivity {
    ...
    LinearLayout munsolved, mlayoutimg;
    ImageView mimage;
    String noreq = "";
    String noticket = "";
    int ratvalue = 0;
...
//                        mrequiredfoto.setVisibility(View.GONE);
    ...
    public void uploadData(){
        ...
        IRetrofit jsonPostService = ServiceGenerator.createService(IRetrofit.class, baseurl);
        jsonPostService.uploadRating(requestBody,
                sesionid_new,noreq, ratvalue,mcomment.getText().toString(),value,ver).enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                String errornya = "";
